        ...
        <div>
          <el-col :lg="6" :md="6" :sm="24" :xl="6" :xs="24" style="margin-bottom: 10px">
            ...
            <el-tooltip placement="top-end">
              ...
              <div class="content">
                <el-progress :percentage="parseFloat(data.cpu.used)" type="dashboard"/>
              </div>
            </el-tooltip>
          ...
          <el-col :lg="6" :md="6" :sm="24" :xl="6" :xs="24" style="margin-bottom: 10px">
            ...
            <el-tooltip placement="top-end">
              ...
              <div class="content">
                <el-progress :percentage="parseFloat(data.memory.usageRate)" type="dashboard"/>
              </div>
            </el-tooltip>
          ...
          <el-col :lg="6" :md="6" :sm="24" :xl="6" :xs="24" style="margin-bottom: 10px">
            ...
            <el-tooltip placement="top-end">
              ...
              <div class="content">
                <el-progress :percentage="parseFloat(data.swap.usageRate)" type="dashboard"/>
              </div>
            </el-tooltip>
          ...
          <el-col :lg="6" :md="6" :sm="24" :xl="6" :xs="24" style="margin-bottom: 10px">
            ...
            <div class="content">
              <el-tooltip placement="top-end">
                ...
                <div class="content">
                  <el-progress :percentage="parseFloat(data.disk.usageRate)" type="dashboard"/>
                </div>
              </el-tooltip>
            </div>
