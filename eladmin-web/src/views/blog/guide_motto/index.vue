  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-input v-model="query.author" class="filter-item"
                  clearable
                  placeholder="作者" style="width: 185px;" @keyup.enter.native="crud.toQuery"/>
        ...
        <el-input v-model="query.type" class="filter-item"
                  clearable
                  placeholder="格言分类" style="width: 185px;" @keyup.enter.native="crud.toQuery"/>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;"
        ...
        <el-table-column label="内容"
                         prop="content"/>
        <el-table-column label="格言分类"
                         prop="type"/>
        <el-table-column v-permission="['admin','motto:edit','motto:del']" align="center"
