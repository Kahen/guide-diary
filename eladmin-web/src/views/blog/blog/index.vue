  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      >
        ...
        <el-table-column label="视频URL" prop="videoUrl"/>
        ...
        <el-table-column label="是否原创" prop="isOriginal"/>
        <el-table-column v-permission="['admin','blog:edit','blog:del']" align="center" label="操作" width="150px">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
export default {
  ...
  cruds() {
    return CRUD({title: 'blog', url: 'api/blog', idField: 'blogId', sort: 'blogId,desc', crudMethod: {...crudBlog}})
  },
  data() {
    return {
      permission: {
      ...
      queryTypeOptions: [
        ...
        {key: 'videoUrl', display_name: '视频URL'},
        {key: 'createTime', display_name: '创建时间'},
        {key: 'publishTime', display_name: '发布时间'},
        {key: 'isOriginal', display_name: '是否原创'}
      ]
    }
  },
  methods: {
