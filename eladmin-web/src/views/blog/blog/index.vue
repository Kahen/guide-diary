  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-input v-model="query.content" class="filter-item"
                  clearable
                  placeholder="内容" style="width: 185px;" @keyup.enter.native="crud.toQuery"/>
        <label class="el-form-item-label">视频URL</label>
        <el-input v-model="query.videoUrl" class="filter-item"
                  clearable
                  placeholder="视频URL" style="width: 185px;" @keyup.enter.native="crud.toQuery"/>
        <label class="el-form-item-label">创建时间</label>
        <el-input v-model="query.createTime" class="filter-item"
                  clearable
                  placeholder="创建时间" style="width: 185px;" @keyup.enter.native="crud.toQuery"/>
        <label class="el-form-item-label">发布时间</label>
        <el-input v-model="query.publishTime" class="filter-item"
                  clearable
                  placeholder="发布时间" style="width: 185px;" @keyup.enter.native="crud.toQuery"/>
        <label class="el-form-item-label">是否原创</label>
        <el-input v-model="query.isOriginal" class="filter-item"
                  clearable
                  placeholder="是否原创" style="width: 185px;" @keyup.enter.native="crud.toQuery"/>
      ...
      <el-dialog :before-close="crud.cancelCU" :close-on-click-modal="false" :title="crud.status.title"
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="80px" size="small">
          ...
          <el-form-item
            ...
            <el-input v-model="form.content" :rows="3" style="width: 370px;"
                      type="textarea"/>
          </el-form-item>
          <el-form-item
            label="视频URL">
          ...
          <el-form-item
            label="是否原创" prop="isOriginal">
            <el-radio v-for="item in dict.is_original" :key="item.id"
                      v-model="form.isOriginal" :label="item.value">{{ item.label }}
            </el-radio>
          </el-form-item>
        </el-form>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;"
        ...
        <el-table-column v-permission="['admin','blog:edit','blog:del']" align="center"
