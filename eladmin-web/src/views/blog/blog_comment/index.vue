    ...
    <div class="head-container">
      ...
      >
        <el-form ref="form" :model="form" :rules="rules" label-width="80px" size="small">
          ...
          <el-form-item label="该评论所在的父级ID">
            <el-input v-model="form.pid" style="width: 370px;"/>
          </el-form-item>
          <el-form-item label="该评论回复的评论ID,没有则为0">
      ...
      >
        ...
        <el-table-column label="评论用户ID" prop="userId"/>
        <el-table-column label="该评论所在的父级ID" prop="pid"/>
        <el-table-column label="该评论回复的评论ID,没有则为0" prop="replyId"/>
        ...
        <el-table-column v-permission="['admin','comment:edit','comment:del']" align="center" label="操作" width="150px">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
const defaultForm = {id: null, blogId: null, userId: null, pid: null, replyId: null, content: null, publishTime: null}
export default {
  name: 'Comment',
  ...
  data() {
    return {
      ...
      rules: {},
      queryTypeOptions: [
        {key: 'id', display_name: '评论ID'},
        {key: 'blogId', display_name: '博客ID'},
        {key: 'userId', display_name: '评论用户ID'}
      ]
    }
  },
  methods: {
