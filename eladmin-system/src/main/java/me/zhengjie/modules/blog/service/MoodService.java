...
public interface MoodService {
     ...
     */
    Map<String, Object> queryAll(MoodQueryCriteria criteria, Pageable pageable);
     ...
     * @return List<MoodDto>
     */
    List<MoodDto> queryAll(MoodQueryCriteria criteria);
    ...
    */
     ...
     * @throws IOException /
     */
    void download(List<MoodDto> all, HttpServletResponse response) throws IOException;
}